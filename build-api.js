...
(function(){
  ...
  buildSendTransaction = function(arg$){
    ...
    return function(arg$, cb){
      var account, to, amount, data, feeType, createTransaction, pushTx, calcFee;
      account = arg$.account, to = arg$.to, amount = arg$.amount, data = arg$.data, feeType = arg$.feeType;
  ...
  buildSendAllFunds = function(arg$){
    ...
    network = arg$.network, provider = arg$.provider;
    return function(arg$, cb){
      var account, to, data, feeType, sendTransaction, getBalance, calcFee;
      account = arg$.account, to = arg$.to, data = arg$.data, feeType = arg$.feeType;
  ...
  buildPair = function(arg$, providers, config, cb){
    var name, api, getModeFor, mode, network, provider, humanizeAmount, unhumanizeAmount, isValidAddress, sendTransaction, createAccount, calcFee, getBalance, getTotalReceived, getHistory, sendAllFunds;
